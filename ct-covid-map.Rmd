...
Covid data used in these maps was compiled by CT Dept. of Public Health through `r format(max(ct.covid$Date), "%b %d, %Y")` and accessed through https://data.ct.gov/stories/s/COVID-19-data/wa3g-tfvc/#data-library.
