##' @title Add a title to a leaflet map
##'
##' @description Function for adding a title to a leaflet map
##'
##' @usage
##' addTitle(object, text, color = "black", fontSize = "20px",
##'  fontFamily = "Sans", leftPosition = 50, topPosition = 2)
##'
##' Cribbed from: https://rdrr.io/github/Lchiffon/leafletCN/src/R/addTitle.R
##'
                      ...
                      topPosition = 2)
{
    ...
    htmlwidgets::onRender(object, paste0("function(el,x){
